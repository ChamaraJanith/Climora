...
// ══════════════════════════════════════════════════════════════════════════════
// USER QUIZ SUBMISSION (any logged-in user)  ← FIXED SECTION
// ══════════════════════════════════════════════════════════════════════════════
describe('[INTEGRATION] GET /api/articles/:articleId/quiz', () => {
    beforeEach(() => jest.clearAllMocks());
    ...
    test('200 — logged-in user can fetch quiz', async () => {
        ...
        const res = await request(app)
            .get('/api/articles/ART-260219-1234/quiz')
            .set('Authorization', 'Bearer fake-jwt-token-for-test');
...
describe('[INTEGRATION] POST /api/articles/:articleId/quiz/submit', () => {
    beforeEach(() => jest.clearAllMocks());
    ...
    test('200 — submits answers and returns score', async () => {
        ...
        const res = await request(app)
            .post('/api/articles/ART-260219-1234/quiz/submit')
            .set('Authorization', 'Bearer fake-jwt-token-for-test')
